                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" v-model="form.privilege"
                                                    :class="{ 'is-invalid': errors.privilege }" type="number"
                                                    placeholder="No. Telp">
                                            </div>
                                            <div v-if="errors.privilege" class="alert alert-danger">
                                                {{ errors.privilege }}
                                            </div>
                                        </div>
                                    </div>
...
export default {
    ...
    setup(props) {
        ...
        const form = reactive({
            ...
            privilege: props.customer.privilege,
